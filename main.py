...
def main():
    ...
    DEF_GROUP_SIZE = 15             # Anzahl Ameisen pro Iteration (m)
    ...
    DEF_ELITE_WEIGHT = 0.8          # Gewichtungsfaktor e für EAS (Folie 9: 0 ≤ e ≤ 1)
    DEF_VISUALIZATION = False       # Live-Plot an/aus
