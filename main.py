"""
Hauptprogramm: Elitäres Ameisen-System (EAS) für das 0/1-Rucksackproblem.

Ablauf gemäß Ant-Cycle-Variante (Folie 7):
1. Alle Ameisen konstruieren vollständige Lösungen
2. Pheromonupdate: Verdampfung + Ablage aller Ameisen + Elite-Bonus
"""
...
def main():
    ...
    elite_weight = 0.8          # Gewichtungsfaktor e für EAS (Folie 9: 0 ≤ e ≤ 1)
    ...
    for iteration in range(iterations):
        ...
        # --- Phase 3: Pheromonupdate gemäß EAS (Folie 9) ---
        # τij,t+1 = (1-ρ)·τij,t + Σ Δk_ij,t + e · Δbs_ij,t
        ...
        # Schritt 3c: Elitärer Bonus (best-so-far) → e · Δbs_ij,t
